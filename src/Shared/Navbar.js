...
const Navbar = () => {
  ...
  const logOutHandle = () => {
    logOut().then(() => toast.warning("Log Out", { autoClose: 1000 }));
  };
    ...
    <>
      <li className="flex items-center">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "font-medium text-[#E32D6F] transition-colors duration-100"
              : "font-medium transition-colors duration-100 text-white"
          }
        >
          Home
        </NavLink>
            ...
            {user ? (
              <div className="flex items-center">
                ...
                <img
                  src={user?.photoURL}
                  alt="user"
                  className="w-[40px] h-[40px] object-cover rounded-full ml-2"
                />
              </div>
            ) : (
              <li>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        <span className="ml-2 text-xl font-bold tracking-wide text-gray-100">
                          Food
                          <span className="text-[#E32D6F] text-2xl">
                            Crunch
                          </span>
                        </span>
                      </Link>
