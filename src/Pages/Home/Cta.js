  ...
  return (
    <div className="pb-20 flex justify-center">
      <section
        ...
        className="py-6 bg-[#F9F5F6] text-gray-50 shadow-md w-[700px]"
      >
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium  uppercase text-gray-900">
              HERE YOU NEED TO CHOOSE WHAT BECAUSE
            </p>
            <h1 className="py-2 text-3xl font-medium  title-font text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
          ...
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            <Link
              to="/login"
              className="inline-flex items-center px-6 py-3 rounded-lg bg-gradient-to-r from-purple-400 to-pink-600 text-gray-900 hover:from-[#d625c2] hover:to-[#f68394]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="fill-current w-7 h-7 text-gray-900"
              >
            ...
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-gradient-to-r from-purple-400 to-pink-600 text-gray-900 hover:from-[#d625c2] hover:to-[#f68394]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                className="fill-current w-7 h-7 text-gray-900"
